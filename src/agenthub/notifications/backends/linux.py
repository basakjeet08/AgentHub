"""Linux desktop notification delivery backend."""
...
class LinuxDesktopNotificationBackend:
    ...
    @classmethod
    def from_system(cls) -> LinuxDesktopNotificationBackend:
        """Create a backend using the Linux desktop commands currently available."""
